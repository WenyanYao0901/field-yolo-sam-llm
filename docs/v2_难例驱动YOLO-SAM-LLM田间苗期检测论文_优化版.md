...
> 图4占位图已从公开仓库删除；待公开授权的真实田间样本就绪后补充。
...
> 图8占位图已从公开仓库删除；待实测 PR 曲线产生后补充。

**图8 PR 曲线（占位）**

> 图9占位图已从公开仓库删除；待实测混淆矩阵产生后补充。
...
> 图10占位图已从公开仓库删除；待实测 IoU/调用率结果产生后补充。
